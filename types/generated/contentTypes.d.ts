...
export interface ApiFifthSectionFifthSection extends Struct.SingleTypeSchema {
  collectionName: 'fifth_sections';
  info: {
    displayName: 'Fifth_Section';
...
export interface ApiFirstSectionFirstSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FirstSecCard: Schema.Attribute.JSON;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.String;
    H1element: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Vid: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
  };
}

export interface ApiPricingPageExtraPricingPageExtra
  extends Struct.SingleTypeSchema {
  collectionName: 'pricing_page_extras';
  info: {
    displayName: 'Pricing_Page_Extra';
    pluralName: 'pricing-page-extras';
    singularName: 'pricing-page-extra';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pricing-page-extra.pricing-page-extra'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    workers_wallet: Schema.Attribute.JSON;
  };
}
...
export interface ApiSecondSectionSecondSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    choices: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
...
export interface ApiThirdSectionThirdSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    feedbackCard: Schema.Attribute.JSON;
    h1text: Schema.Attribute.String;
    h2text: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::pricing-page-extra.pricing-page-extra': ApiPricingPageExtraPricingPageExtra;
